...
| Register or verify a passkey | `Passkey::` | [17](17-passwordless.md) | `json_encode()` the ceremony options |
...
| [17-passwordless.md](17-passwordless.md) | Magic links and passkeys (M8) |
