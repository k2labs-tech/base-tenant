...
| `resources/lang/{locale}/*.php` | `lang/tenant/` |
...
JSON translation files go to the `lang/` root rather than `lang/tenant/`:
...
remembering this file exists. It is registered in `bootstrap/providers.php`
automatically.
