...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('base-tenant.dashboard') }}" wire:navigate>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('base-tenant.dashboard')" :active="request()->routeIs('base-tenant.dashboard')" wire:navigate>
                        {{ __('Dashboard') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-4">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('base-tenant.profile')" wire:navigate>
                            {{ __('Profile') }}
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('base-tenant.dashboard')" :active="request()->routeIs('base-tenant.dashboard')" wire:navigate>
                {{ __('Dashboard') }}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('base-tenant.profile')" wire:navigate>
                    {{ __('Profile') }}
                </x-responsive-nav-link>
