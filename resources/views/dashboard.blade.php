<x-app-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl p-6 shadow-soft hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-primary-600">{{ __('app.dashboard.stats.total_revenue') }}</p>
                    ...
                    <p class="text-xs text-success mt-2 flex items-center">
                        ...
                        {{ __('app.dashboard.stats.from_last_month', ['percent' => 12]) }}
                    </p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-soft hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-primary-600">{{ __('app.dashboard.stats.active_users') }}</p>
                    <p class="text-2xl font-semibold text-primary-900 mt-1">2,543</p>
                    <p class="text-xs text-success mt-2 flex items-center">
                        <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 7.414V15a1 1 0 11-2 0V7.414L6.707 9.707a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                        </svg>
                        {{ __('app.dashboard.stats.from_last_week', ['percent' => 8]) }}
                    </p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-soft hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-primary-600">{{ __('app.dashboard.stats.conversion_rate') }}</p>
                    ...
                    <p class="text-xs text-error mt-2 flex items-center">
                        ...
                        {{ __('app.dashboard.stats.from_last_week', ['percent' => -3]) }}
                    </p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-soft hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-primary-600">{{ __('app.dashboard.stats.avg_session') }}</p>
                    <p class="text-2xl font-semibold text-primary-900 mt-1">4m 23s</p>
                    <p class="text-xs text-primary-500 mt-2">{{ __('app.dashboard.stats.no_change') }}</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-soft p-6">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-lg font-semibold text-primary-900">{{ __('app.dashboard.revenue_overview') }}</h3>
            ...
            <div class="bg-white rounded-xl shadow-soft">
                <div class="px-6 py-4 border-b border-surface-200">
                    <h3 class="text-lg font-semibold text-primary-900">{{ __('app.dashboard.recent_activity') }}</h3>
                </div>
        ...
        <div class="space-y-6">
            <!-- Quick Actions -->
            <div class="bg-white rounded-xl shadow-soft p-6">
                <h3 class="text-lg font-semibold text-primary-900 mb-4">{{ __('app.dashboard.quick_actions') }}</h3>
                <div class="space-y-3">
            ...
            <div class="bg-white rounded-xl shadow-soft p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-primary-900">{{ __('app.dashboard.team_members') }}</h3>
                    <a href="#" class="text-sm text-accent-600 hover:text-accent-700">{{ __('app.dashboard.view_all') }}</a>
                </div>
                <div class="space-y-3">
                    <!-- Team Member -->
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-primary-500">{{ __('app.dashboard.roles.admin') }}</p>
                        </div>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-primary-500">{{ __('app.dashboard.roles.developer') }}</p>
                        </div>
                        <span class="w-2 h-2 bg-success rounded-full"></span>
                    </div>
                    <!-- Team Member -->
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-primary-500">{{ __('app.dashboard.roles.designer') }}</p>
                        </div>
